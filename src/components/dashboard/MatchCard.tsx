    ...
    <div className="bg-bg-main rounded-lg p-6 border border-border hover:border-accent-primary/40 transition-all duration-200 shadow-sm hover:shadow-md">
      ...
      <div className="mb-4">
        <div className="flex items-center text-sm text-text-main font-open-sans mb-1">
          ...
          <span className="capitalize">{formatDate(localDate)}</span>
        </div>
      ...
      <div className="flex gap-2 pt-4 border-t border-border">
        <Link
          ...
          className="flex-1 px-4 py-2 bg-bg-secondary text-text-main text-center rounded-lg hover:bg-bg-secondary/80 transition-colors font-open-sans font-medium text-sm"
        >
          Ver Detalles
        </Link>
          ...
          <>
            {match.user_status === 'confirmed' ? (
              <button
                ...
                className="px-4 py-2 bg-error/10 text-error border border-error/20 rounded-lg hover:bg-error/20 transition-colors font-open-sans font-medium text-sm"
              >
                Salir
              </button>
              ...
              <button
                disabled
                className="px-4 py-2 bg-warning/10 text-warning border border-warning/20 rounded-lg opacity-50 cursor-not-allowed font-open-sans font-medium text-sm"
              >
                Pendiente
              </button>
            ) : (
              <button
                ...
                className="px-4 py-2 bg-accent-primary text-black rounded-lg hover:bg-accent-primary/90 transition-colors font-open-sans font-medium text-sm"
              >
                Unirse
              </button>
            )}
