      ...
      <div className="min-h-screen bg-bg-secondary">
        ...
        <main className="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
          <div className="px-4 py-6 sm:px-0">
            ...
            {/* Statistics Summary */}
            <div className="bg-bg-main overflow-hidden shadow-lg rounded-lg mb-6 border border-border">
            ...
            <div className="bg-bg-main overflow-hidden shadow-lg rounded-lg mb-6 border border-border">
              <div className="px-4 py-5 sm:p-6">
                <h2 className="text-2xl font-bold text-text-main font-montserrat mb-4">
                  ¡Bienvenido a tu Dashboard!
                </h2>
                <p className="text-text-secondary font-open-sans mb-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {/* Profile Info */}
                  <div className="bg-accent-primary/10 rounded-lg p-6 border border-accent-primary/20 hover:border-accent-primary/40 transition-colors">
                    <div className="flex items-center">
                      <div className="flex-shrink-0">
                        <div className="w-12 h-12 bg-accent-primary/20 rounded-lg flex items-center justify-center">
                          <svg className="h-6 w-6 text-accent-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  {/* Contact Info */}
                  <div className="bg-success/10 rounded-lg p-6 border border-success/20 hover:border-success/40 transition-colors">
                    <div className="flex items-center">
                      <div className="flex-shrink-0">
                  ...
                  {/* Location Info */}
                  <div className="bg-accent-secondary/10 rounded-lg p-6 border border-accent-secondary/20 hover:border-accent-secondary/40 transition-colors">
                    <div className="flex items-center">
                      <div className="flex-shrink-0">
                        <div className="w-12 h-12 bg-accent-secondary/20 rounded-lg flex items-center justify-center">
                          <svg className="h-6 w-6 text-accent-secondary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="px-4 py-5 sm:p-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
                  <button 
                    ...
                    className="bg-accent-primary text-white p-4 rounded-lg hover:bg-accent-primary/90 transition-colors text-center shadow-sm"
                  >
                  ...
                  <Link href="/dashboard/players" className="bg-success text-white p-4 rounded-lg hover:bg-success/90 transition-colors text-center block shadow-sm">
                    <svg className="h-8 w-8 mx-auto mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <Link href="/dashboard/groups" className="bg-accent-secondary text-white p-4 rounded-lg hover:bg-accent-secondary/90 transition-colors text-center block shadow-sm">
                    <svg className="h-8 w-8 mx-auto mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <Link href="/dashboard/matches" className="bg-info text-white p-4 rounded-lg hover:bg-info/90 transition-colors text-center block shadow-sm">
                    <svg className="h-8 w-8 mx-auto mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5H7a2 2 0 00-2 2v10a2 2 0 002 2h8a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4" />
                    </svg>
                    <span className="font-semibold font-open-sans">Partidos</span>
                  </Link>

                  <Link href="/dashboard/stats" className="bg-accent-primary text-white p-4 rounded-lg hover:bg-accent-primary/90 transition-colors text-center block shadow-sm">
                    <svg className="h-8 w-8 mx-auto mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
                    </svg>
                    <span className="font-semibold font-open-sans">Estadísticas</span>
                  </Link>

                  <Link href="/dashboard/profile" className="bg-warning text-white p-4 rounded-lg hover:bg-warning/90 transition-colors text-center block shadow-sm">
                    <svg className="h-8 w-8 mx-auto mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="bg-bg-main overflow-hidden shadow-lg rounded-lg border border-border">
              <div className="px-4 py-5 sm:p-6">
                ...
                <div className="space-y-4">
                  <div className="flex items-center p-4 bg-accent-primary/5 rounded-lg border border-accent-primary/10 hover:border-accent-primary/20 transition-colors">
                    <div className="flex-shrink-0">
                    ...
                    <div className="ml-4 flex-1">
                      <p className="text-sm font-medium text-text-main font-open-sans">
                  ...
                  <div className="flex items-center p-4 bg-success/5 rounded-lg border border-success/10 hover:border-success/20 transition-colors">
                    <div className="flex-shrink-0">
                  ...
                  <div className="flex items-center p-4 bg-accent-secondary/5 rounded-lg border border-accent-secondary/10 hover:border-accent-secondary/20 transition-colors">
                    <div className="flex-shrink-0">
                  ...
                  <div className="text-center pt-4">
                    <button className="text-accent-primary hover:text-accent-primary/80 font-open-sans text-sm font-medium transition-colors">
